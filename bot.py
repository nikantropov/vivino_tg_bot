...
async def start_command(update, context):
    ...
    await update.message.reply_text(
        ...
        "Каждая ваша оценка помогает нашим винам быть заметнее \U0001f60a\n\n"
        "\U0001f4cb <b>Как участвовать:</b>\n"
        "1. Зарегистрируйте рабочий email (\u0434\u043e\u043c\u0435\u043d luding.ru)\n"
        "2. Загрузите скриншот с оценкой вин недели из приложения Vivino\n"
        "3. Каждый понедельник — розыгрыш среди участников \U0001f377\n\n"
        "Каждый скриншот \u2013 больше шансов на победу \U0001f3b2",
